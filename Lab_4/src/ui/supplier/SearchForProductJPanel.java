...
//        Product productid = productcatalog.searchProduct(Integer.parseInt(idField.getText()));
//        if(productid == null){
//       JOptionPane.showMessageDialog(null, "Product ID you entered does not exist","Information",JOptionPane.INFORMATION_MESSAGE);
//            
//                } 
//        else{
//        ViewProductDetailJPanel vpdjp = new ViewProductDetailJPanel(workArea,productid);
//        workArea.add("ViewProductDetailJPanel",vpdjp);
//        CardLayout layout = (CardLayout) workArea.getLayout();
//        layout.next (workArea);
//    try {
        // Fetch the latest ProductCatalog before performing the search
        this.productcatalog = supplier.getProductCatalog();
...
//    }
    // Optionally clear the text field after each search
    idField.setText("");
